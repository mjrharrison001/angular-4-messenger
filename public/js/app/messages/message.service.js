...
var MessageService = (function () {
    ...
    MessageService.prototype.addMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ...
            : '';
        return this.http.post('https://messages-app-angular-4.herokuapp.com/message' + token, body, { headers: headers })
    ...
    MessageService.prototype.getMessages = function () {
        var _this = this;
        return this.http.get('https://messages-app-angular-4.herokuapp.com/message')
            .map(function (response) {
    ...
    MessageService.prototype.deleteMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ? '?token=' + localStorage.getItem('token')
            : '';
        return this.http.delete('https://messages-app-angular-4.herokuapp.com/message/' + message.messageId + token)
    ...
    MessageService.prototype.updateMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ? '?token=' + localStorage.getItem('token')
            : '';
        return this.http.patch('https://messages-app-angular-4.herokuapp.com/message/' + message.messageId + token, body, { headers: headers })
            .map(function (response) { return response.json(); })
            .catch(function (error) {
            _this.errorService.handleError(error.json());
            return Observable.throw(error.json());
